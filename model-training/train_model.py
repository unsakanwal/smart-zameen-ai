...
def save_all(model, le_crop, le_season, le_region):
    # Save the trained .pkl artifacts into backend/ml_models/ (where the app loads them).
    out = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'backend', 'ml_models')
